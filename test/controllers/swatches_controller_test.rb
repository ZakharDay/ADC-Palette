...
class SwatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create swatch" do
    assert_difference("Swatch.count") do
      post swatches_url, params: { swatch: { place: @swatch.place, project_id: @swatch.project_id } }
    end
  ...
  test "should update swatch" do
    patch swatch_url(@swatch), params: { swatch: { place: @swatch.place, project_id: @swatch.project_id } }
