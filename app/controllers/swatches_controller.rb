class SwatchesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @swatch.save
        format.html { redirect_to swatch_url(@swatch), notice: "Swatch was successfully created." }
  ...
  def update
    respond_to do |format|
      if @swatch.update(swatch_params)
        format.html { redirect_to swatch_url(@swatch), notice: "Swatch was successfully updated." }
  ...
  private
    ...
    def swatch_params
      params.require(:swatch).permit(:project_id, :place)
    end
end
